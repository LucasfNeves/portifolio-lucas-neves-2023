...
export function CardProject({
  ...
  return (
    <article
      key={id}
      className="group relative w-full sm:w-[24rem] md:w-[23rem] lg:w-full xl:w-[23rem] min-h-[21.5rem] bg-gray-800 px-7 flex items-center lg:items-start flex-col hover:scale-105  justify-center rounded-2xl trasition duration-200 ease-in-out hover:bg-opacity-50"
    >
